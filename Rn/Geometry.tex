...
\tdplotdrawarc{(O)}{0.2}{0}{30}{anchor=north}{$\theta$}
\tdplotsetthetaplanecoords{\phivec}
\tdplotdrawarc[tdplot_rotated_coords]{(0,0,0)}{0.5}{0}{\thetavec}{anchor=south west}{$\phi$}
\tdplotsetcoord{P}{1}{60}{30}
\draw[-stealth,color=red] (O) -- (Pxy);
\draw[-stealth,color=blue] (O) -- (Pyz);
\draw[-stealth,color=green] (O) -- (Pxz);
\end{tikzpicture}
...
Rotation by $\theta$ about the $x$-axis has the following standard matr1ix:
\[
\begin{bmatrix*}[C]
1 & 0 & 0\\
0 & \cos \theta &  -\sin \theta \\
...
Rotation by $\phi$ about the $y$-axis has the following standard matrix:
\[
\begin{bmatrix*}[C]
\cos \phi & 0 & \sin \phi \\
0 & 1 &  0 \\
...
Rotation by $\psi$ about the $z$-axis has the following standard matrix:
\[
\begin{bmatrix*}[C]
\cos \psi &-\sin \psi  & 0\\
\sin \psi & \cos \psi & 0 \\
