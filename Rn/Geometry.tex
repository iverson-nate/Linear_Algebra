...
\begin{proposition} If $\vec{v}_1, \vec{v}_2, \ldots, \vec{v}_n \in \mathbb{R}^n$ are linearly dependent. Then at at least one of the vectors, $\vec{v}_k$, can be written as a linear combination of the others. That is,
$$
