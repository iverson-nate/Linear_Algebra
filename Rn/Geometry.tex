...
$\vec{b}=\begin{bmatrix} 1 \\ -2 \end{bmatrix}$. That is $\mathcal{A}(\vec{v})=\vec{v}+\vec{b}$. Clearly $\mathcal{A}$ is not a linear transformation
...
\begin{align*}
T(\vec{e}_1)&=\begin{bmatrix} \sqrt{3}/2 \\ 1/2\end{bmatrix}\\
T(\vec{e}_2)&=\begin{bmatrix} -1/2 \\ \sqrt{3}/2\end{bmatrix}
\end{align*}
\end{example}
