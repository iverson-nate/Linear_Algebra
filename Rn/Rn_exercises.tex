...
\begin{inparaenum}[a.)]
\begin{tabular}{llll}
\item $3 \begin{bmatrix*}[C] 1 \\ 0\\ -5\end{bmatrix*}$ \quad &
\item $\begin{bmatrix*}[C]1 \\ 0\\ -5\end{bmatrix*} + \begin{bmatrix}4 \\ 1\\ 
7\end{bmatrix}$ \quad & 
\item $3\begin{bmatrix*}[C]1 \\ 0\\ -5\end{bmatrix*} + 2\begin{bmatrix}4 \\ 1\\ 
7\end{bmatrix}$ \quad &
